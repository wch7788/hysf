!function (t, e) {
    ...
    var e = "SweetAlert2:", i = function (e) {
        ...
        g = function (t, e) {
            ...
            p(e.classList).forEach(function (t) {
                -1 === i(x).indexOf(t) && -1 === i(f).indexOf(t) && e.classList.remove(t)
            }), t && t[n] && S(e, t[n])
        };
    ...
    var y = function (t) {
            ...
            return H(x["progress-steps"])
        }, z = function () {
            return H(x["validation-message"])
        }, W = function () {
            return j("." + x.actions + " ." + x.confirm)
        }, K = function () {
            return j("." + x.actions + " ." + x.cancel)
        }, F = function () {
            return H(x.actions)
        }, Z = function () {
            return H(x.header)
            ...
            var t = p(R().querySelectorAll('[tabindex]:not([tabindex="-1"]):not([tabindex="0"])')).sort(function (t, e) {
                    return t = parseInt(t.getAttribute("tabindex")), (e = parseInt(e.getAttribute("tabindex"))) < t ? 1 : t < e ? -1 : 0
                }),
                e = p(R().querySelectorAll('a[href], area[href], input:not([disabled]), select:not([disabled]), textarea:not([disabled]), button:not([disabled]), iframe, object, embed, [tabindex="0"], [contenteditable], audio[controls], video[controls]')).filter(function (t) {
            ...
            return !X() && !document.body.classList.contains(x["no-backdrop"])
        }, X = function () {
        ...
        et = function (t) {
            ...
            if (e && (e.parentNode.removeChild(e), L([document.documentElement, document.body], [x["no-backdrop"], x["toast-shown"], x["has-column"]])), !G()) {
                ...
                o.appendChild(n);
                var i, r = R(), a = D(), s = E(a, x.input), c = E(a, x.file),
                    u = a.querySelector(".".concat(x.range, " input")),
                    l = a.querySelector(".".concat(x.range, " output")), d = E(a, x.select),
                    p = a.querySelector(".".concat(x.checkbox, " input")), f = E(a, x.textarea);
                ...
                var m = function (t) {
                    jt.isVisible() && i !== t.target.value && jt.resetValidationMessage(), i = t.target.value
                };
            ...
            if (t instanceof HTMLElement) e.appendChild(t); else if ("object" === w(t)) if (e.innerHTML = "", 0 in t) for (var n = 0; n in t; n++) e.appendChild(t[n].cloneNode(!0)); else e.appendChild(t.cloneNode(!0)); else t && (e.innerHTML = t)
        }, ot = function () {
            if (G()) return !1;
            ...
            t.html ? (nt(t.html, e), T(e, "block")) : t.text ? (e.textContent = t.text, T(e, "block")) : O(e), function (e) {
                for (var t, n = D(), o = ["input", "file", "range", "select", "radio", "checkbox", "textarea"], i = function (t) {
                ...
                switch (e.input) {
                    ...
                    case"file":
                        ...
                        break;
                    case"range":
                        var d = E(n, x.range), p = d.querySelector("input"), f = d.querySelector("output");
                    ...
                    case"radio":
                        ...
                        break;
                    case"checkbox":
                        var v = E(n, x.checkbox), b = A(n, "checkbox");
            ...
            }(), -1 !== Object.keys(f).indexOf(t.type)) {
    ...
    var at = function (i) {
        var r = _(), a = parseInt(null === i.currentProgressStep ? jt.getQueueStep() : i.currentProgressStep, 10);
        ...
        }), n.background && (o.style.background = n.background), o.className = x.popup, n.toast ? (S([document.documentElement, document.body], x["toast-shown"]), S(o, x.toast)) : S(o, x.modal), b(o, n.customClass, "popup"), "string" == typeof n.customClass && S(o, n.customClass), n.animation ? L(o, x.noanimation) : S(o, x.noanimation), function (t) {
            var e = q();
            if (e) {
    ...
    var ut = [], lt = function () {
        ...
        gt = function (t) {
            ...
            queue: function (t) {
                ...
                ut = t;
                var a = function (t, e) {
                    ut = [], document.body.removeAttribute("data-swal2-queue-step"), t(e)
                }, s = [];
            ...
            stopTimer: function () {
                return dt.timeout && dt.timeout.stop()
            },
            resumeTimer: function () {
                return dt.timeout && dt.timeout.start()
            },
            ...
            increaseTimer: function (t) {
                return dt.timeout && dt.timeout.increase(t)
            },
    ...
    function yt() {
        var t = bt.innerParams.get(this), e = bt.domCache.get(this);
    ...
    function xt(t) {
        var e = q(), n = R(), o = bt.innerParams.get(this), i = Bt.swalPromiseResolve.get(this), r = o.onClose,
            a = o.onAfterClose;
        if (n) {
            ...
            var s = function () {
                ...
                }(), "undefined" != typeof window && Ct() && window.removeEventListener("resize", kt), p(document.body.children).forEach(function (t) {
                    t.hasAttribute("data-previous-aria-hidden") ? (t.setAttribute("aria-hidden", t.getAttribute("data-previous-aria-hidden")), t.removeAttribute("data-previous-aria-hidden")) : t.removeAttribute("aria-hidden")
                }))
            };
            ot && !g(n, x.noanimation) ? n.addEventListener(ot, function t() {
                n.removeEventListener(ot, t), g(n, x.hide) && s()
            }) : s(), i(t || {})
        }
    }
    ...
    var Tt = function (t) {
        var e = q(), n = R();
        null !== t.onBeforeOpen && "function" == typeof t.onBeforeOpen && t.onBeforeOpen(n), t.animation ? (S(n, x.show), S(e, x.fade), L(n, x.hide)) : L(n, x.fade), T(n), e.style.overflowY = "hidden", ot && !g(n, x.noanimation) ? n.addEventListener(ot, function t() {
            n.removeEventListener(ot, t), e.style.overflowY = "auto"
        }) : e.style.overflowY = "auto", S([document.documentElement, document.body, e], x.shown), t.heightAuto && t.backdrop && !t.toast && S([document.documentElement, document.body], x["height-auto"]), J() && (t.scrollbarPadding && wt(), function () {
        ...
        }(), "undefined" != typeof window && Ct() && (kt(), window.addEventListener("resize", kt)), p(document.body.children).forEach(function (t) {
            t === q() || function (t, e) {
            ...
            e.scrollTop = 0
        })), X() || dt.previousActiveElement || (dt.previousActiveElement = document.activeElement), null !== t.onOpen && "function" == typeof t.onOpen && setTimeout(function () {
            t.onOpen(n)
        })
    }, Ot = {
    ...
    var Mt, Vt = Object.freeze({
        hideLoading: yt, disableLoading: yt, getInput: function (t) {
            var e = bt.innerParams.get(t || this);
            return A(bt.domCache.get(t || this).content, e.input)
        }, close: xt, closePopup: xt, closeModal: xt, closeToast: xt, enableButtons: function () {
            Pt(this, ["confirmButton", "cancelButton"], !1)
        }, disableButtons: function () {
            Pt(this, ["confirmButton", "cancelButton"], !0)
        }, enableConfirmButton: function () {
            Pt(this, ["confirmButton"], !1)
        }, disableConfirmButton: function () {
            Pt(this, ["confirmButton"], !0)
            ...
            return bt.innerParams.get(this).progressSteps
            ...
            var p = this;
            !function (t) {
                for (var e in t) gt(e) || C('Unknown parameter "'.concat(e, '"')), t.toast && -1 !== mt.indexOf(e) && C('The parameter "'.concat(e, '" is incompatible with toasts')), ht(e) && (n = 'The parameter "'.concat(e, '" is deprecated and will be removed in the next major release. Please use "').concat(ht(e), '" instead.'), -1 === h.indexOf(n) && (h.push(n), C(n)));
                var n
            }(t);
            var f = s({}, pt, t);
            !function (e) {
                e.inputValidator || Object.keys(Et).forEach(function (t) {
                    e.input === t && (e.inputValidator = Et[t])
                ...
                var t = R(), n = "string" == typeof e.target ? document.querySelector(e.target) : e.target;
            ...
            return new Promise(function (t) {
                ...
                Bt.swalPromiseResolve.set(p, t), f.timer && (dt.timeout = new Lt(function () {
                    s("timer"), delete dt.timeout
                ...
                for (var c = function (e) {
                    f.showLoaderOnConfirm && g.showLoading(), f.preConfirm ? (p.resetValidationMessage(), Promise.resolve().then(function () {
                        ...
                        V(m.validationMessage) || !1 === t ? p.hideLoading() : n(void 0 === t ? e : t)
                    })) : n(e)
                }, e = function (t) {
                ...
                if (dt.keydownHandlerAdded && (dt.keydownTarget.removeEventListener("keydown", dt.keydownHandler, {capture: dt.keydownListenerCapture}), dt.keydownHandlerAdded = !1), f.toast || (dt.keydownHandler = function (t) {
                    ...
                    var u = D(), l = function (t) {
                        return Ot[f.input](u, (e = t, n = [], "undefined" != typeof Map && e instanceof Map ? e.forEach(function (t, e) {
                            n.push([e, t])
                    ...
                    var d = g.getInput();
                    g.showLoading(), O(d), f.inputValue.then(function (t) {
                        d.value = "number" === f.input ? parseFloat(t) || 0 : t + "", T(d), d.focus(), p.hideLoading()
                    }).catch(function (t) {
                        k("Error in inputValue promise: " + t), d.value = "", T(d), d.focus(), p.hideLoading()
                    })
                }
    ...
    }, s(qt.prototype, Vt), s(qt, vt), Object.keys(Vt).forEach(function (e) {
        qt[e] = function () {
            var t;
            if (Mt) return (t = Mt)[e].apply(t, arguments)
        }
    }), qt.DismissReason = t, qt.version = "8.7.0";
    var jt = qt;
